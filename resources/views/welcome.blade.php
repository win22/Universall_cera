...
<head>
    ...
    <link href="{{ asset('site/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css') }}" rel="stylesheet" type="text/css">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><i class="fa fa-phone"></i> (+221) 33 878 65 60</div></div>
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><i class="fa fa-envelope"></i> Info@Universallglobal.Com</div></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 float-left">
                        <div class="logo_container">
                            <div class="logo"><img style="width: 200px;" src="{{ asset('images/logoucs.jpg') }}"></div>
                        </div>
                    </div>

                    <!-- Search -->
                    <div class="col-lg-6 col-md-6 float-right text-lg-left text-right">
                            ...
                            <div class="header_search_content">
                                <div class="header_search_form_container">
                                    <form  action="#" class="header_search_form clearfix">
                                        ...
                                        <button  style="background-color: tomato !important;" type="submit" class="header_search_button trans_300" value="Submit"><img src="{{asset('site/images/search.png') }}" alt=""></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="main_nav_content d-flex flex-row">
                            ...
                            <div class="main_nav_menu ml-auto">
                                <ul class="standard_dropdown main_nav_dropdown">
                                    <li><a style="color: white" href="/">Acceuil<i class="fas fa-chevron-down"></i></a></li>
                                    <li class="hassubs">
                                        <a href="#">Catalogues<i class="fas fa-chevron-down"></i></a>
                                    ...
                                    <li class="hassubs">
                                        <a href="#">Nos réalisations<i class="fas fa-chevron-down"></i></a>
                                    </li>
                                    <li class="hassubs">
                                        <a href="#">Qui sommes nous?<i class="fas fa-chevron-down"></i></a>
                                    </li>
                                    <li><a href="blog.html">Nous contacter<i class="fas fa-chevron-down"></i></a></li>
...
<script src="{{asset('site/plugins/greensock/TweenMax.min.js') }}"></script>
<script src="{{asset('site/plugins/greensock/TimelineMax.min.js') }}"></script>
<script src="{{asset('site/plugins/scrollmagic/ScrollMagic.min.js') }}"></script>
<script src="{{asset('site/plugins/greensock/animation.gsap.min.js') }}"></script>
<script src="{{asset('site/plugins/greensock/ScrollToPlugin.min.js') }}"></script>
<script src="{{asset('site/plugins/OwlCarousel2-2.2.1/owl.carousel.js') }}"></script>
<script src="{{asset('site/plugins/slick-1.8.0/slick.js') }}"></script>
